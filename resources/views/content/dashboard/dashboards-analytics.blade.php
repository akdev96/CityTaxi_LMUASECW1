    ...
    <div class="card">
      <div class="d-flex align-items-start row">
        <div class="col-sm-7">
          <div class="card-body">
              @if(Auth::check())
                <h5 class="card-title text-primary mb-3">Congratulations {{ Auth::user()->first_name }}! 🎉</h5>
              @else
          ...
          <div class="tab-pane fade show active" id="navs-tabs-line-card-income" role="tabpanel">
            <div class="d-flex mb-6">
              ...
              <div>
                ...
                <div class="d-flex align-items-center">
                  <h6 class="mb-0 me-1">Rs 459.10</h6>
            ...
            <div class="d-flex align-items-center justify-content-center mt-6 gap-3">
              ...
              <div>
                ...
                <small>Rs 39k less than last week</small>
              </div>
            </div>
          </div>
        </div>
          ...
          <li class="d-flex align-items-center mb-6">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">+82.6</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
          <li class="d-flex align-items-center mb-6">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">+270.69</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
          <li class="d-flex align-items-center mb-6">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">+637.91</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
          <li class="d-flex align-items-center mb-6">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">-838.71</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
          <li class="d-flex align-items-center mb-6">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">+203.33</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
          <li class="d-flex align-items-center">
            ...
            <div class="d-flex w-100 flex-wrap align-items-center justify-content-between gap-2">
              ...
              <div class="user-progress d-flex align-items-center gap-2">
                <h6 class="fw-normal mb-0">-92.45</h6> <span class="text-muted">LKR</span>
              </div>
            </div>
          </li>
        </ul>

        ...
        <div class="card-body">
          ...
          <form id="formAuthentication" class="mb-6" action="{{ route('register') }}" method="POST">
            ...
            <div class="mb-6">
              ...
              <input type="text" class="form-control" id="nic_no" name="nic_no" placeholder="000000000000" autofocus>
            </div>
            <div class="mb-6">
              <label for="license_no" class="form-label">Driving License No</label>
              <input type="text" class="form-control" id="license_no" name="license_no" placeholder="00000000" autofocus>
            </div>
            <div class="mb-6">
              <label for="vehicle_no" class="form-label">Vehicle No</label>
              <input type="text" class="form-control" id="vehicle_no" name="vehicle_no" placeholder="WP ABC 1234" autofocus>
            </div>
